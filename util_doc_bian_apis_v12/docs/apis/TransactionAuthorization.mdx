...
## Table of Contents
- [POST: /TransactionAuthorization/Evaluate](#post-/transactionauthorization/evaluate)
- [PUT: /TransactionAuthorization/\{transactionauthorizationid\}/Update](#put-/transactionauthorization/\{transactionauthorizationid\}/update)
- [PUT: /TransactionAuthorization/\{transactionauthorizationid\}/Execute](#put-/transactionauthorization/\{transactionauthorizationid\}/execute)
- [PUT: /TransactionAuthorization/\{transactionauthorizationid\}/Request](#put-/transactionauthorization/\{transactionauthorizationid\}/request)
- [GET: /TransactionAuthorization/\{transactionauthorizationid\}/Retrieve](#get-/transactionauthorization/\{transactionauthorizationid\}/retrieve)
