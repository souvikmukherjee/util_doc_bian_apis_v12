...
## Table of Contents
- [POST: /PaymentExecution/Initiate](#post-/paymentexecution/initiate)
- [PUT: /PaymentExecution/\{paymentexecutionid\}/Update](#put-/paymentexecution/\{paymentexecutionid\}/update)
- [GET: /PaymentExecution/\{paymentexecutionid\}/Retrieve](#get-/paymentexecution/\{paymentexecutionid\}/retrieve)
- [GET: /PaymentExecution/\{paymentexecutionid\}/PaymentMechanism/\{paymentmechanismid\}/Retrieve](#get-/paymentexecution/\{paymentexecutionid\}/paymentmechanism/\{paymentmechanismid\}/retrieve)
- [PUT: /PaymentExecution/\{paymentexecutionid\}/PaymentExecution/\{paymentexecutionid\}/Control](#put-/paymentexecution/\{paymentexecutionid\}/paymentexecution/\{paymentexecutionid\}/control)
- [GET: /PaymentExecution/\{paymentexecutionid\}/PaymentExecution/\{paymentexecutionid\}/Retrieve](#get-/paymentexecution/\{paymentexecutionid\}/paymentexecution/\{paymentexecutionid\}/retrieve)
