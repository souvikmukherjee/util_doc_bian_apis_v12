...
## Table of Contents
- [POST: /CustomerAccessEntitlement/Evaluate](#post-/customeraccessentitlement/evaluate)
- [PUT: /CustomerAccessEntitlement/\{customeraccessentitlementid\}/Update](#put-/customeraccessentitlement/\{customeraccessentitlementid\}/update)
- [PUT: /CustomerAccessEntitlement/\{customeraccessentitlementid\}/Control](#put-/customeraccessentitlement/\{customeraccessentitlementid\}/control)
- [PUT: /CustomerAccessEntitlement/\{customeraccessentitlementid\}/Exchange](#put-/customeraccessentitlement/\{customeraccessentitlementid\}/exchange)
- [PUT: /CustomerAccessEntitlement/\{customeraccessentitlementid\}/Request](#put-/customeraccessentitlement/\{customeraccessentitlementid\}/request)
- [PUT: /CustomerAccessEntitlement/\{customeraccessentitlementid\}/Grant](#put-/customeraccessentitlement/\{customeraccessentitlementid\}/grant)
- [GET: /CustomerAccessEntitlement/\{customeraccessentitlementid\}/Retrieve](#get-/customeraccessentitlement/\{customeraccessentitlementid\}/retrieve)
- [POST: /CustomerAccessEntitlement/\{customeraccessentitlementid\}/Restrictions/Evaluate](#post-/customeraccessentitlement/\{customeraccessentitlementid\}/restrictions/evaluate)
- [PUT: /CustomerAccessEntitlement/\{customeraccessentitlementid\}/Restrictions/\{restrictionsid\}/Update](#put-/customeraccessentitlement/\{customeraccessentitlementid\}/restrictions/\{restrictionsid\}/update)
- [GET: /CustomerAccessEntitlement/\{customeraccessentitlementid\}/Restrictions/\{restrictionsid\}/Retrieve](#get-/customeraccessentitlement/\{customeraccessentitlementid\}/restrictions/\{restrictionsid\}/retrieve)
- [POST: /CustomerAccessEntitlement/\{customeraccessentitlementid\}/Preferences/Evaluate](#post-/customeraccessentitlement/\{customeraccessentitlementid\}/preferences/evaluate)
- [PUT: /CustomerAccessEntitlement/\{customeraccessentitlementid\}/Preferences/\{preferencesid\}/Update](#put-/customeraccessentitlement/\{customeraccessentitlementid\}/preferences/\{preferencesid\}/update)
- [GET: /CustomerAccessEntitlement/\{customeraccessentitlementid\}/Preferences/\{preferencesid\}/Retrieve](#get-/customeraccessentitlement/\{customeraccessentitlementid\}/preferences/\{preferencesid\}/retrieve)
