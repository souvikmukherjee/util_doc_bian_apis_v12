...
## Table of Contents
- [POST: /ProspectCampaignDesign/Create](#post-/prospectcampaigndesign/create)
- [PUT: /ProspectCampaignDesign/\{prospectcampaigndesignid\}/Update](#put-/prospectcampaigndesign/\{prospectcampaigndesignid\}/update)
- [PUT: /ProspectCampaignDesign/\{prospectcampaigndesignid\}/Capture](#put-/prospectcampaigndesign/\{prospectcampaigndesignid\}/capture)
- [PUT: /ProspectCampaignDesign/\{prospectcampaigndesignid\}/Execute](#put-/prospectcampaigndesign/\{prospectcampaigndesignid\}/execute)
- [PUT: /ProspectCampaignDesign/\{prospectcampaigndesignid\}/Request](#put-/prospectcampaigndesign/\{prospectcampaigndesignid\}/request)
- [GET: /ProspectCampaignDesign/\{prospectcampaigndesignid\}/Retrieve](#get-/prospectcampaigndesign/\{prospectcampaigndesignid\}/retrieve)
