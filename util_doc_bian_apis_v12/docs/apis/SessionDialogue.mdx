...
## Table of Contents
- [POST: /SessionDialogue/Initiate](#post-/sessiondialogue/initiate)
- [PUT: /SessionDialogue/\{sessiondialogueid\}/Update](#put-/sessiondialogue/\{sessiondialogueid\}/update)
- [PUT: /SessionDialogue/\{sessiondialogueid\}/Execute](#put-/sessiondialogue/\{sessiondialogueid\}/execute)
- [PUT: /SessionDialogue/\{sessiondialogueid\}/Request](#put-/sessiondialogue/\{sessiondialogueid\}/request)
- [GET: /SessionDialogue/\{sessiondialogueid\}/Retrieve](#get-/sessiondialogue/\{sessiondialogueid\}/retrieve)
- [POST: /SessionDialogue/\{sessiondialogueid\}/Query/Initiate](#post-/sessiondialogue/\{sessiondialogueid\}/query/initiate)
- [PUT: /SessionDialogue/\{sessiondialogueid\}/Query/\{queryid\}/Update](#put-/sessiondialogue/\{sessiondialogueid\}/query/\{queryid\}/update)
- [GET: /SessionDialogue/\{sessiondialogueid\}/Query/\{queryid\}/Retrieve](#get-/sessiondialogue/\{sessiondialogueid\}/query/\{queryid\}/retrieve)
- [PUT: /SessionDialogue/\{sessiondialogueid\}/Authentication/\{authenticationid\}/Update](#put-/sessiondialogue/\{sessiondialogueid\}/authentication/\{authenticationid\}/update)
- [GET: /SessionDialogue/\{sessiondialogueid\}/Authentication/\{authenticationid\}/Retrieve](#get-/sessiondialogue/\{sessiondialogueid\}/authentication/\{authenticationid\}/retrieve)
- [POST: /SessionDialogue/\{sessiondialogueid\}/Sales/Initiate](#post-/sessiondialogue/\{sessiondialogueid\}/sales/initiate)
- [PUT: /SessionDialogue/\{sessiondialogueid\}/Sales/\{salesid\}/Update](#put-/sessiondialogue/\{sessiondialogueid\}/sales/\{salesid\}/update)
- [GET: /SessionDialogue/\{sessiondialogueid\}/Sales/\{salesid\}/Retrieve](#get-/sessiondialogue/\{sessiondialogueid\}/sales/\{salesid\}/retrieve)
- [POST: /SessionDialogue/\{sessiondialogueid\}/Offer/Initiate](#post-/sessiondialogue/\{sessiondialogueid\}/offer/initiate)
- [PUT: /SessionDialogue/\{sessiondialogueid\}/Offer/\{offerid\}/Update](#put-/sessiondialogue/\{sessiondialogueid\}/offer/\{offerid\}/update)
- [GET: /SessionDialogue/\{sessiondialogueid\}/Offer/\{offerid\}/Retrieve](#get-/sessiondialogue/\{sessiondialogueid\}/offer/\{offerid\}/retrieve)
- [POST: /SessionDialogue/\{sessiondialogueid\}/ProductorService/Initiate](#post-/sessiondialogue/\{sessiondialogueid\}/productorservice/initiate)
- [PUT: /SessionDialogue/\{sessiondialogueid\}/ProductorService/\{productorserviceid\}/Update](#put-/sessiondialogue/\{sessiondialogueid\}/productorservice/\{productorserviceid\}/update)
- [GET: /SessionDialogue/\{sessiondialogueid\}/ProductorService/\{productorserviceid\}/Retrieve](#get-/sessiondialogue/\{sessiondialogueid\}/productorservice/\{productorserviceid\}/retrieve)
- [POST: /SessionDialogue/\{sessiondialogueid\}/Case/Initiate](#post-/sessiondialogue/\{sessiondialogueid\}/case/initiate)
- [PUT: /SessionDialogue/\{sessiondialogueid\}/Case/\{caseid\}/Update](#put-/sessiondialogue/\{sessiondialogueid\}/case/\{caseid\}/update)
- [GET: /SessionDialogue/\{sessiondialogueid\}/Case/\{caseid\}/Retrieve](#get-/sessiondialogue/\{sessiondialogueid\}/case/\{caseid\}/retrieve)
- [POST: /SessionDialogue/\{sessiondialogueid\}/Order/Initiate](#post-/sessiondialogue/\{sessiondialogueid\}/order/initiate)
- [PUT: /SessionDialogue/\{sessiondialogueid\}/Order/\{orderid\}/Update](#put-/sessiondialogue/\{sessiondialogueid\}/order/\{orderid\}/update)
- [GET: /SessionDialogue/\{sessiondialogueid\}/Order/\{orderid\}/Retrieve](#get-/sessiondialogue/\{sessiondialogueid\}/order/\{orderid\}/retrieve)
- [POST: /SessionDialogue/\{sessiondialogueid\}/Intelligence/Initiate](#post-/sessiondialogue/\{sessiondialogueid\}/intelligence/initiate)
- [PUT: /SessionDialogue/\{sessiondialogueid\}/Intelligence/\{intelligenceid\}/Update](#put-/sessiondialogue/\{sessiondialogueid\}/intelligence/\{intelligenceid\}/update)
- [GET: /SessionDialogue/\{sessiondialogueid\}/Intelligence/\{intelligenceid\}/Retrieve](#get-/sessiondialogue/\{sessiondialogueid\}/intelligence/\{intelligenceid\}/retrieve)
- [PUT: /SessionDialogue/\{sessiondialogueid\}/History/\{historyid\}/Update](#put-/sessiondialogue/\{sessiondialogueid\}/history/\{historyid\}/update)
- [GET: /SessionDialogue/\{sessiondialogueid\}/History/\{historyid\}/Retrieve](#get-/sessiondialogue/\{sessiondialogueid\}/history/\{historyid\}/retrieve)
...
PUT /session\_dialogue/\{session\_dialogue\_id\}/offer/\{offer\_id\}
...
GET: The name of the path should be \`/sessions/\{session\_id\}/products/\{product\_id\}\` for better adherence to REST best practices\.
