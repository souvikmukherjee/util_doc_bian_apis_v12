...
## Table of Contents
- [PUT: /SpecialPricingConditions/\{specialpricingconditionsid\}/Control](#put-/specialpricingconditions/\{specialpricingconditionsid\}/control)
- [PUT: /SpecialPricingConditions/\{specialpricingconditionsid\}/Exchange](#put-/specialpricingconditions/\{specialpricingconditionsid\}/exchange)
- [PUT: /SpecialPricingConditions/\{specialpricingconditionsid\}/Execute](#put-/specialpricingconditions/\{specialpricingconditionsid\}/execute)
- [POST: /SpecialPricingConditions/Initiate](#post-/specialpricingconditions/initiate)
- [GET: /SpecialPricingConditions/\{specialpricingconditionsid\}/Retrieve](#get-/specialpricingconditions/\{specialpricingconditionsid\}/retrieve)
- [PUT: /SpecialPricingConditions/\{specialpricingconditionsid\}/Request](#put-/specialpricingconditions/\{specialpricingconditionsid\}/request)
- [PUT: /SpecialPricingConditions/\{specialpricingconditionsid\}/Update](#put-/specialpricingconditions/\{specialpricingconditionsid\}/update)
- [POST: /SpecialPricingConditions/\{specialpricingconditionsid\}/PricingTerms/Initiate](#post-/specialpricingconditions/\{specialpricingconditionsid\}/pricingterms/initiate)
- [GET: /SpecialPricingConditions/\{specialpricingconditionsid\}/PricingTerms/\{pricingtermsid\}/Retrieve](#get-/specialpricingconditions/\{specialpricingconditionsid\}/pricingterms/\{pricingtermsid\}/retrieve)
- [PUT: /SpecialPricingConditions/\{specialpricingconditionsid\}/PricingTerms/\{pricingtermsid\}/Update](#put-/specialpricingconditions/\{specialpricingconditionsid\}/pricingterms/\{pricingtermsid\}/update)
