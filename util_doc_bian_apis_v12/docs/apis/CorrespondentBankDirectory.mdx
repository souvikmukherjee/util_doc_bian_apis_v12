...
## Table of Contents
- [POST: /CorrespondentBankDirectory/Register](#post-/correspondentbankdirectory/register)
- [PUT: /CorrespondentBankDirectory/\{correspondentbankdirectoryid\}/Update](#put-/correspondentbankdirectory/\{correspondentbankdirectoryid\}/update)
- [PUT: /CorrespondentBankDirectory/\{correspondentbankdirectoryid\}/Request](#put-/correspondentbankdirectory/\{correspondentbankdirectoryid\}/request)
- [GET: /CorrespondentBankDirectory/\{correspondentbankdirectoryid\}/Retrieve](#get-/correspondentbankdirectory/\{correspondentbankdirectoryid\}/retrieve)
