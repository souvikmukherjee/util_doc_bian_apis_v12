...
## Table of Contents
- [PUT: /ComplianceReporting/\{compliancereportingid\}/Capture](#put-/compliancereporting/\{compliancereportingid\}/capture)
- [POST: /ComplianceReporting/Initiate](#post-/compliancereporting/initiate)
- [GET: /ComplianceReporting/\{compliancereportingid\}/Retrieve](#get-/compliancereporting/\{compliancereportingid\}/retrieve)
- [PUT: /ComplianceReporting/\{compliancereportingid\}/Request](#put-/compliancereporting/\{compliancereportingid\}/request)
- [PUT: /ComplianceReporting/\{compliancereportingid\}/Update](#put-/compliancereporting/\{compliancereportingid\}/update)
- [PUT: /ComplianceReporting/\{compliancereportingid\}/ComplianceAssessment/\{complianceassessmentid\}/Capture](#put-/compliancereporting/\{compliancereportingid\}/complianceassessment/\{complianceassessmentid\}/capture)
- [PUT: /ComplianceReporting/\{compliancereportingid\}/Consolidation/\{consolidationid\}/Capture](#put-/compliancereporting/\{compliancereportingid\}/consolidation/\{consolidationid\}/capture)
- [PUT: /ComplianceReporting/\{compliancereportingid\}/Remediation/\{remediationid\}/Capture](#put-/compliancereporting/\{compliancereportingid\}/remediation/\{remediationid\}/capture)
- [POST: /ComplianceReporting/\{compliancereportingid\}/Remediation/Initiate](#post-/compliancereporting/\{compliancereportingid\}/remediation/initiate)
- [GET: /ComplianceReporting/\{compliancereportingid\}/ComplianceAssessment/\{complianceassessmentid\}/Retrieve](#get-/compliancereporting/\{compliancereportingid\}/complianceassessment/\{complianceassessmentid\}/retrieve)
- [GET: /ComplianceReporting/\{compliancereportingid\}/Consolidation/\{consolidationid\}/Retrieve](#get-/compliancereporting/\{compliancereportingid\}/consolidation/\{consolidationid\}/retrieve)
- [GET: /ComplianceReporting/\{compliancereportingid\}/Remediation/\{remediationid\}/Retrieve](#get-/compliancereporting/\{compliancereportingid\}/remediation/\{remediationid\}/retrieve)
- [PUT: /ComplianceReporting/\{compliancereportingid\}/ComplianceAssessment/\{complianceassessmentid\}/Request](#put-/compliancereporting/\{compliancereportingid\}/complianceassessment/\{complianceassessmentid\}/request)
- [PUT: /ComplianceReporting/\{compliancereportingid\}/Consolidation/\{consolidationid\}/Request](#put-/compliancereporting/\{compliancereportingid\}/consolidation/\{consolidationid\}/request)
- [PUT: /ComplianceReporting/\{compliancereportingid\}/Remediation/\{remediationid\}/Request](#put-/compliancereporting/\{compliancereportingid\}/remediation/\{remediationid\}/request)
- [PUT: /ComplianceReporting/\{compliancereportingid\}/ComplianceAssessment/\{complianceassessmentid\}/Update](#put-/compliancereporting/\{compliancereportingid\}/complianceassessment/\{complianceassessmentid\}/update)
- [PUT: /ComplianceReporting/\{compliancereportingid\}/Consolidation/\{consolidationid\}/Update](#put-/compliancereporting/\{compliancereportingid\}/consolidation/\{consolidationid\}/update)
- [PUT: /ComplianceReporting/\{compliancereportingid\}/Remediation/\{remediationid\}/Update](#put-/compliancereporting/\{compliancereportingid\}/remediation/\{remediationid\}/update)
...
PUT: The name of the path should be \`/compliance\-reportings/\{compliance\-reporting\-id\}/requests\` to follow REST best practices\. The path segments should be in lowercase and separated by hyphens\, and resource names should be in plural form\. Additionally\, using snake case for variable names like \`compliance\_reporting\_id\` is also a good convention to follow\.
