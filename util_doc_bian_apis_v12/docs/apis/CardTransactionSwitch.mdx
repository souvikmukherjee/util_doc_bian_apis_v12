...
## Table of Contents
- [POST: /CardTransactionSwitch/Initiate](#post-/cardtransactionswitch/initiate)
- [PUT: /CardTransactionSwitch/\{cardtransactionswitchid\}/Update](#put-/cardtransactionswitch/\{cardtransactionswitchid\}/update)
- [GET: /CardTransactionSwitch/\{cardtransactionswitchid\}/Retrieve](#get-/cardtransactionswitch/\{cardtransactionswitchid\}/retrieve)
- [POST: /CardTransactionSwitch/\{cardtransactionswitchid\}/TransactionCapture/Initiate](#post-/cardtransactionswitch/\{cardtransactionswitchid\}/transactioncapture/initiate)
- [GET: /CardTransactionSwitch/\{cardtransactionswitchid\}/TransactionCapture/\{transactioncaptureid\}/Retrieve](#get-/cardtransactionswitch/\{cardtransactionswitchid\}/transactioncapture/\{transactioncaptureid\}/retrieve)
- [POST: /CardTransactionSwitch/\{cardtransactionswitchid\}/TransactionRouting/Initiate](#post-/cardtransactionswitch/\{cardtransactionswitchid\}/transactionrouting/initiate)
- [GET: /CardTransactionSwitch/\{cardtransactionswitchid\}/TransactionRouting/\{transactionroutingid\}/Retrieve](#get-/cardtransactionswitch/\{cardtransactionswitchid\}/transactionrouting/\{transactionroutingid\}/retrieve)
