...
## Table of Contents
- [POST: /ProductionRelease/Evaluate](#post-/productionrelease/evaluate)
- [PUT: /ProductionRelease/\{productionreleaseid\}/Update](#put-/productionrelease/\{productionreleaseid\}/update)
- [PUT: /ProductionRelease/\{productionreleaseid\}/Request](#put-/productionrelease/\{productionreleaseid\}/request)
- [GET: /ProductionRelease/\{productionreleaseid\}/Retrieve](#get-/productionrelease/\{productionreleaseid\}/retrieve)
- [GET: /ProductionRelease/\{productionreleaseid\}/FunctionalRisk/\{functionalriskid\}/Retrieve](#get-/productionrelease/\{productionreleaseid\}/functionalrisk/\{functionalriskid\}/retrieve)
- [GET: /ProductionRelease/\{productionreleaseid\}/ProductionRisk/\{productionriskid\}/Retrieve](#get-/productionrelease/\{productionreleaseid\}/productionrisk/\{productionriskid\}/retrieve)
- [GET: /ProductionRelease/\{productionreleaseid\}/BusinessRisk/\{businessriskid\}/Retrieve](#get-/productionrelease/\{productionreleaseid\}/businessrisk/\{businessriskid\}/retrieve)
- [GET: /ProductionRelease/\{productionreleaseid\}/OperationalRisk/\{operationalriskid\}/Retrieve](#get-/productionrelease/\{productionreleaseid\}/operationalrisk/\{operationalriskid\}/retrieve)
