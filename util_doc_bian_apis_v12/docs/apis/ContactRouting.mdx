...
## Table of Contents
- [POST: /ContactRouting/Provide](#post-/contactrouting/provide)
- [PUT: /ContactRouting/\{contactroutingid\}/Update](#put-/contactrouting/\{contactroutingid\}/update)
- [PUT: /ContactRouting/\{contactroutingid\}/Capture](#put-/contactrouting/\{contactroutingid\}/capture)
- [GET: /ContactRouting/\{contactroutingid\}/Retrieve](#get-/contactrouting/\{contactroutingid\}/retrieve)
- [PUT: /ContactRouting/\{contactroutingid\}/Allocation/\{allocationid\}/Request](#put-/contactrouting/\{contactroutingid\}/allocation/\{allocationid\}/request)
- [PUT: /ContactRouting/\{contactroutingid\}/Allocation/\{allocationid\}/Update](#put-/contactrouting/\{contactroutingid\}/allocation/\{allocationid\}/update)
- [PUT: /ContactRouting/\{contactroutingid\}/Allocation/\{allocationid\}/Capture](#put-/contactrouting/\{contactroutingid\}/allocation/\{allocationid\}/capture)
- [GET: /ContactRouting/\{contactroutingid\}/Allocation/\{allocationid\}/Retrieve](#get-/contactrouting/\{contactroutingid\}/allocation/\{allocationid\}/retrieve)
