...
## Table of Contents
- [POST: /FraudEvaluation/Evaluate](#post-/fraudevaluation/evaluate)
- [GET: /FraudEvaluation/\{fraudevaluationid\}/Retrieve](#get-/fraudevaluation/\{fraudevaluationid\}/retrieve)
- [GET: /FraudEvaluation/\{fraudevaluationid\}/RuleSetsandDecisionTrees/\{rulesetsanddecisiontreesid\}/Retrieve](#get-/fraudevaluation/\{fraudevaluationid\}/rulesetsanddecisiontrees/\{rulesetsanddecisiontreesid\}/retrieve)
- [GET: /FraudEvaluation/\{fraudevaluationid\}/Models/\{modelsid\}/Retrieve](#get-/fraudevaluation/\{fraudevaluationid\}/models/\{modelsid\}/retrieve)
