...
## Table of Contents
- [POST: /eBranchOperations/Initiate](#post-/ebranchoperations/initiate)
- [PUT: /eBranchOperations/\{ebranchoperationsid\}/Update](#put-/ebranchoperations/\{ebranchoperationsid\}/update)
- [PUT: /eBranchOperations/\{ebranchoperationsid\}/Request](#put-/ebranchoperations/\{ebranchoperationsid\}/request)
- [GET: /eBranchOperations/\{ebranchoperationsid\}/Retrieve](#get-/ebranchoperations/\{ebranchoperationsid\}/retrieve)
- [POST: /eBranchOperations/\{ebranchoperationsid\}/Inbound/Initiate](#post-/ebranchoperations/\{ebranchoperationsid\}/inbound/initiate)
- [GET: /eBranchOperations/\{ebranchoperationsid\}/Inbound/\{inboundid\}/Retrieve](#get-/ebranchoperations/\{ebranchoperationsid\}/inbound/\{inboundid\}/retrieve)
- [POST: /eBranchOperations/\{ebranchoperationsid\}/Outbound/Initiate](#post-/ebranchoperations/\{ebranchoperationsid\}/outbound/initiate)
- [GET: /eBranchOperations/\{ebranchoperationsid\}/Outbound/\{outboundid\}/Retrieve](#get-/ebranchoperations/\{ebranchoperationsid\}/outbound/\{outboundid\}/retrieve)
