...
## Table of Contents
- [POST: /GuidelineCompliance/Evaluate](#post-/guidelinecompliance/evaluate)
- [PUT: /GuidelineCompliance/\{guidelinecomplianceid\}/Update](#put-/guidelinecompliance/\{guidelinecomplianceid\}/update)
- [GET: /GuidelineCompliance/\{guidelinecomplianceid\}/Retrieve](#get-/guidelinecompliance/\{guidelinecomplianceid\}/retrieve)
