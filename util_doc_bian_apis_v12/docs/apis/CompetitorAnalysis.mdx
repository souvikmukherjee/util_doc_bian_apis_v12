...
## Table of Contents
- [POST: /CompetitorAnalysis/Evaluate](#post-/competitoranalysis/evaluate)
- [PUT: /CompetitorAnalysis/\{competitoranalysisid\}/Execute](#put-/competitoranalysis/\{competitoranalysisid\}/execute)
- [PUT: /CompetitorAnalysis/\{competitoranalysisid\}/Request](#put-/competitoranalysis/\{competitoranalysisid\}/request)
- [GET: /CompetitorAnalysis/\{competitoranalysisid\}/Retrieve](#get-/competitoranalysis/\{competitoranalysisid\}/retrieve)
