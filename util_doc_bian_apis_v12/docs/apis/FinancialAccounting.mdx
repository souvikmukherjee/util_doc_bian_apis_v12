...
## Table of Contents
- [POST: /FinancialAccounting/Initiate](#post-/financialaccounting/initiate)
- [PUT: /FinancialAccounting/\{financialaccountingid\}/Update](#put-/financialaccounting/\{financialaccountingid\}/update)
- [GET: /FinancialAccounting/\{financialaccountingid\}/Retrieve](#get-/financialaccounting/\{financialaccountingid\}/retrieve)
- [PUT: /FinancialAccounting/\{financialaccountingid\}/LedgerPosting/\{ledgerpostingid\}/Update](#put-/financialaccounting/\{financialaccountingid\}/ledgerposting/\{ledgerpostingid\}/update)
- [PUT: /FinancialAccounting/\{financialaccountingid\}/LedgerPosting/\{ledgerpostingid\}/Capture](#put-/financialaccounting/\{financialaccountingid\}/ledgerposting/\{ledgerpostingid\}/capture)
- [GET: /FinancialAccounting/\{financialaccountingid\}/LedgerPosting/\{ledgerpostingid\}/Retrieve](#get-/financialaccounting/\{financialaccountingid\}/ledgerposting/\{ledgerpostingid\}/retrieve)
