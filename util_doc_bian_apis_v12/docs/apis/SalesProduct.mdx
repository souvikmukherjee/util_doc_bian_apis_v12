...
## Table of Contents
- [POST: /SalesProduct/Evaluate](#post-/salesproduct/evaluate)
- [PUT: /SalesProduct/\{salesproductid\}/Update](#put-/salesproduct/\{salesproductid\}/update)
- [PUT: /SalesProduct/\{salesproductid\}/Control](#put-/salesproduct/\{salesproductid\}/control)
- [GET: /SalesProduct/\{salesproductid\}/Retrieve](#get-/salesproduct/\{salesproductid\}/retrieve)
- [POST: /SalesProduct/\{salesproductid\}/OperationalTerm/Evaluate](#post-/salesproduct/\{salesproductid\}/operationalterm/evaluate)
- [PUT: /SalesProduct/\{salesproductid\}/OperationalTerm/\{operationaltermid\}/Update](#put-/salesproduct/\{salesproductid\}/operationalterm/\{operationaltermid\}/update)
- [PUT: /SalesProduct/\{salesproductid\}/OperationalTerm/\{operationaltermid\}/Exchange](#put-/salesproduct/\{salesproductid\}/operationalterm/\{operationaltermid\}/exchange)
- [PUT: /SalesProduct/\{salesproductid\}/OperationalTerm/\{operationaltermid\}/Grant](#put-/salesproduct/\{salesproductid\}/operationalterm/\{operationaltermid\}/grant)
- [GET: /SalesProduct/\{salesproductid\}/OperationalTerm/\{operationaltermid\}/Retrieve](#get-/salesproduct/\{salesproductid\}/operationalterm/\{operationaltermid\}/retrieve)
