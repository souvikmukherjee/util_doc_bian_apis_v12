...
## Table of Contents
- [POST: /CustomerProductAndServiceEligibility/Evaluate](#post-/customerproductandserviceeligibility/evaluate)
- [PUT: /CustomerProductAndServiceEligibility/\{customerproductandserviceeligibilityid\}/Update](#put-/customerproductandserviceeligibility/\{customerproductandserviceeligibilityid\}/update)
- [PUT: /CustomerProductAndServiceEligibility/\{customerproductandserviceeligibilityid\}/Exchange](#put-/customerproductandserviceeligibility/\{customerproductandserviceeligibilityid\}/exchange)
- [PUT: /CustomerProductAndServiceEligibility/\{customerproductandserviceeligibilityid\}/Execute](#put-/customerproductandserviceeligibility/\{customerproductandserviceeligibilityid\}/execute)
- [PUT: /CustomerProductAndServiceEligibility/\{customerproductandserviceeligibilityid\}/Request](#put-/customerproductandserviceeligibility/\{customerproductandserviceeligibilityid\}/request)
- [PUT: /CustomerProductAndServiceEligibility/\{customerproductandserviceeligibilityid\}/Grant](#put-/customerproductandserviceeligibility/\{customerproductandserviceeligibilityid\}/grant)
- [GET: /CustomerProductAndServiceEligibility/\{customerproductandserviceeligibilityid\}/Retrieve](#get-/customerproductandserviceeligibility/\{customerproductandserviceeligibilityid\}/retrieve)
- [GET: /CustomerProductAndServiceEligibility/\{customerproductandserviceeligibilityid\}/EligibilityCheck/\{eligibilitycheckid\}/Retrieve](#get-/customerproductandserviceeligibility/\{customerproductandserviceeligibilityid\}/eligibilitycheck/\{eligibilitycheckid\}/retrieve)
- [PUT: /CustomerProductAndServiceEligibility/\{customerproductandserviceeligibilityid\}/NextBest/\{nextbestid\}/Update](#put-/customerproductandserviceeligibility/\{customerproductandserviceeligibilityid\}/nextbest/\{nextbestid\}/update)
- [GET: /CustomerProductAndServiceEligibility/\{customerproductandserviceeligibilityid\}/NextBest/\{nextbestid\}/Retrieve](#get-/customerproductandserviceeligibility/\{customerproductandserviceeligibilityid\}/nextbest/\{nextbestid\}/retrieve)
