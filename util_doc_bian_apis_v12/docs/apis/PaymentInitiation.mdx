...
## Table of Contents
- [POST: /PaymentInitiation/Initiate](#post-/paymentinitiation/initiate)
- [PUT: /PaymentInitiation/\{paymentinitiationid\}/Update](#put-/paymentinitiation/\{paymentinitiationid\}/update)
- [GET: /PaymentInitiation/\{paymentinitiationid\}/Retrieve](#get-/paymentinitiation/\{paymentinitiationid\}/retrieve)
- [GET: /PaymentInitiation/\{paymentinitiationid\}/Compliance/\{complianceid\}/Retrieve](#get-/paymentinitiation/\{paymentinitiationid\}/compliance/\{complianceid\}/retrieve)
- [GET: /PaymentInitiation/\{paymentinitiationid\}/FundingCheck/\{fundingcheckid\}/Retrieve](#get-/paymentinitiation/\{paymentinitiationid\}/fundingcheck/\{fundingcheckid\}/retrieve)
- [GET: /PaymentInitiation/\{paymentinitiationid\}/OrderInitiation/\{orderinitiationid\}/Retrieve](#get-/paymentinitiation/\{paymentinitiationid\}/orderinitiation/\{orderinitiationid\}/retrieve)
